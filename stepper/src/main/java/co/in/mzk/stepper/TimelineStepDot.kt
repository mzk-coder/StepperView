...
internal class TimelineStepDot(context: Context, attrs: AttributeSet?, defStyleAttr: Int)
    ...
    init {
        View.inflate(getContext(), R.layout.timeline_dot, this)
        isEnabled = false
    ...
    private fun setupAnimator() {
        pulseAnimator = AnimatorInflater.loadAnimator(context, R.animator.pulse) as AnimatorSet
